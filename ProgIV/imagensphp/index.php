...
<head>
    ...
    <link rel="icon" href="">
    <title>manutenção de arquivos</title>
    <!-- Bootstrap core CSS -->
    ...
    <div class="container">
        ...
        if ($_POST) {        
            ...
            if ( $arquivo != "none" )
            {
                ...
                try { 
                    $result = mysqli_query($mysqli,"INSERT INTO tb_arquivos ( arquivo_nome, arquivo_titulo, arquivo_conteudo, arquivo_tipo) VALUES ('$nome','$titulo','$conteudo','$tipo')");
			
                                       
                     echo '<br/><div class="alert alert-success" role="alert">
                                Arquivo enviado com sucesso para o servidor!
                            </div>';
		          } catch(Exception $e) { // caso retorne erro
